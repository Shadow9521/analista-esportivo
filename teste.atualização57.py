...
if True:
    ...
    with col_grafico:
        ...
        df_comparacao = pd.DataFrame({
            "Probabilidade (%)": [vitoria, empate, derrota, mercado_casa, mercado_empate, mercado_fora],
            "Fonte": ["Sua análise"] * 3 + ["Mercado"] * 3,
            "Resultado": [time_casa, "Empate", time_fora] * 2
        })
        ...
        fig.update_traces(textinfo="percent+label", pull=[0.05, 0, 0.05])
        fig.update_layout(
            height=400,
            margin=dict(t=10, b=10, l=10, r=10),
            showlegend=True,
            legend_title_text='Resultado',
            title_text="Comparativo: Sua análise vs Mercado"
        )
